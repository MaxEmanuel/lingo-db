...
runtime::VarLen32 runtime::ArrayRuntime::add(runtime::VarLen32 str1, int dim1, runtime::VarLen32 type1, runtime::VarLen32 str2, int dim2, runtime::VarLen32 type2) {
    if (type1.str() != type2.str()) {
        throw std::runtime_error("Both arrays should have the same type - Type-1: " + type1.str() + "; Type-2: " + type2.str());
    }
...
runtime::VarLen32 runtime::ArrayRuntime::sub(runtime::VarLen32 str1, int dim1, runtime::VarLen32 type1, runtime::VarLen32 str2, int dim2, runtime::VarLen32 type2) {
    if (type1.str() != type2.str()) {
        throw std::runtime_error("Both arrays should have the same type - Type-1: " + type1.str() + "; Type-2: " + type2.str());
    }
...
runtime::VarLen32 runtime::ArrayRuntime::castToArray(runtime::VarLen32 str, int dimensions, runtime::VarLen32 type) {
   if (type.str() == "int32[]") {
